...
if ($Profile -eq 'auto') { $Profile = if ($sm -le 75) { 'legacy' } else { 'modern' } }
...
$prompt = 'Write a practical design review for running a 26B Mixture-of-Experts coding assistant on a laptop. Compare 4 GB, 6 GB, 8 GB, 10 GB, and 12 GB VRAM. Explain expert caching, SSD streaming, three failure modes, and give a final recommendation. Use Markdown headings and a table. Aim for about 350 words.'
$port = 11436
$runs = @(
